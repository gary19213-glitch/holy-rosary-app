        ...
        <div style={{ textAlign: "center", backgroundColor: "#16213e", padding: "15px", borderRadius: "12px", border: "1px solid #333" }}>
          ...
          {currentBead === 0 && (
            <div style={{ marginTop: "15px", paddingTop: "15px", borderTop: "1px solid #444", fontSize: "14px", color: "#a0a0a0", textAlign: "left" }}>
              ...
              <p><strong>Reflection:</strong> {currentDecadeData.reflection}</p>
            </div>
          )}
        </div>

        <div style={{ position: "fixed", bottom: "30px", left: "20px", right: "20px" }}>
          <button onClick={nextBead} style={{ backgroundColor: "#d4af37", color: "#1a1a2e", padding: "16px", width: "100%", borderRadius: "30px", fontSize: "18px", fontWeight: "bold", border: "none", boxShadow: "0 4px 10px rgba(212, 175, 55, 0.3)" }}>
            Next Prayer ➔
          </button>
        </div>
      </div>
    ...
    <div style={{ padding: "20px", backgroundColor: "#1a1a2e", color: "white", minHeight: "100vh" }}>
      ...
      <main>
        <div style={{ backgroundColor: "#16213e", padding: "24px", borderRadius: "16px", textAlign: "center", border: "1px solid #d4af37", marginBottom: "20px", boxShadow: "0 4px 15px rgba(0,0,0,0.3)" }}>
          ...
          <button onClick={() => setScreen("rosary")} style={{ backgroundColor: "#d4af37", color: "#1a1a2e", padding: "14px", width: "100%", borderRadius: "30px", fontSize: "18px", fontWeight: "bold", border: "none" }}>
            ▶ Start Praying
          </button>
        </div>
