...
export default function Home() {
  ...
  const nextPrayer = () => {
    ...
    // IF WE ARE IN STATIONS OF THE CROSS
    if (screen === "stations") {
      ...
      {screen === "home" && (
        <>
          ...
          <div style={{ backgroundColor: "rgba(0,0,0,0.4)", padding: "24px", borderRadius: "16px", textAlign: "center", border: "1px solid #d4af37", marginBottom: "20px", boxShadow: "0 4px 20px rgba(0,0,0,0.5)" }}>
            ...
            <div style={{ display: "flex", justifyContent: "space-between", fontSize: "14px", color: "#ccc", marginBottom: "15px", padding: "10px", backgroundColor: "rgba(0,0,0,0.2)", borderRadius: "8px" }}><span>{todayName}</span><span style={{ color: "#d4af37", fontWeight: "bold" }}>{liturgicalSeason}</span></div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "15px" }}>
            ...
            {/* STATIONS OF THE CROSS BUTTON ACTIVATED! */}
            ...
            <div style={{ backgroundColor: "rgba(0,0,0,0.4)", padding: "20px 10px", borderRadius: "16px", textAlign: "center", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "15px", fontWeight: "bold", border: "1px solid rgba(255,255,255,0.1)" }}>My Custom Lists</div>
          </div>
        </>
      )}

      {/* --- STATIONS OF THE CROSS SCREEN (Features 46, 48, 49) --- */}
      {screen === "stations" && (() => {
        ...
        return (
          <div style={{ paddingBottom: "100px" }}>
            ...
            {/* Huge Roman Numeral Layout */}
            <div style={{ textAlign: "center", marginBottom: "30px", marginTop: "40px" }}>
              <h1 style={{ fontSize: "80px", color: "#d4af37", margin: "0", opacity: 0.8, textShadow: "0px 4px 15px rgba(212, 175, 55, 0.3)" }}>{station.numeral}</h1>
              <h2 style={{ fontSize: "24px", color: "#fff", marginTop: "10px", padding: "0 10px" }}>{station.title}</h2>
            </div>
            ...
            <div style={{ position: "fixed", bottom: "30px", left: "20px", right: "20px" }}>
              <button onClick={nextPrayer} style={{ backgroundColor: "#d4af37", color: "#1a1a2e", padding: "16px", width: "100%", borderRadius: "30px", fontSize: "18px", fontWeight: "bold", border: "none", boxShadow: "0 4px 10px rgba(0,0,0,0.5)" }}>
                {currentStation === stationsOfCross.length - 1 ? "Finish Stations ✓" : "Next Station ➔"}
              </button>
            </div>
          </div>
        );
